...
var au = function () {
    ...
    ad.addEventListener('click', function () {
        ...
        if ( typeof app.custTracker != 'undefined' && app.custTracker != '') {
            ...
            app.linkOpener('http://www.nutriclub.co.id/onestepahead/?utm_source=MobileNetwork_OSA_Mobile_RMB_Violin&utm_medium=mobile&utm_campaign=OneStepAhead&utm_content=OneStepAhead');
        }
